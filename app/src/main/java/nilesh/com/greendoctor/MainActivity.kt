package nilesh.com.greendoctor
...
import nilesh.com.greendoctor.R
...
class MainActivity : AppCompatActivity() {
    ...
    private val mSamplePath = "appicon.png"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        resources.assets.open(mSamplePath).use {
            ...
            with(mPhotoImageView) { mPhotoImageView.setImageBitmap(mBitmap) }
        }
